...
# --- ΔΕΔΟΜΕΝΑ ΠΡΟΪΟΝΤΩΝ (ΜΕ ΤΑ ΔΙΚΑ ΣΟΥ ΒΙΝΤΕΟ) ---
products = {
    "Φακή Χασίων": {
        ...
        "video": "https://www.youtube.com/shorts/m0md-5Wzp1E" # Το δικό σου βίντεο 1
    },
    "Φασόλια Γίγαντες": {
        ...
        "video": "https://www.youtube.com/shorts/SKGdu1x0sxo" # Το δικό σου βίντεο 2
    }
}
...
# 3. Εικόνα Συσκευασίας (Από το GitHub σου)
try:
...
# 5. ΠΡΑΓΜΑΤΙΚΟ ΒΙΝΤΕΟ ΨΕΚΑΣΜΟΥ (UAV IN ACTION)
