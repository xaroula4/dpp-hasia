...
# CSS ΓΙΑ ΤΟ ΤΕΛΙΚΟ MOBILE LOOK (v15.0 - Fixed Visibility)
st.markdown("""
    <style>
    ...
    .info-card b, .info-card p, .info-card span { color: #333 !important; }
...
<div class="journey-row">
    ...
    <div class="journey-item">
        <span class="journey-icon">🚁</span>
        <span class="journey-label">UAV</span>
...
# 9. Storytelling (Fixed Text Color)
...
with col_qr:
    st.image(qr_code_api, caption="Batch QR", width=100)
with col_txt:
...
st.markdown("<p style='text-align:center; font-size:10px; color:#999; margin-top:15px;'>ΟΣΠΡΙΑ ΧΑΣΙΩΝ DPP v15.0</p>", unsafe_allow_html=True)
