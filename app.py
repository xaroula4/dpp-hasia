...
products = {
    "Φακή Χασίων": {
        ...
        "health": "96%", 
        "img": "fakes.JPEG", 
        "video": "https://www.youtube.com/watch?v=4Yv-TeeJ_2o", # Βίντεο για Φακές
    ...
    "Φασόλια Γίγαντες": {
        ...
        "health": "98%", 
        "img": "gigantes.png", 
        "video": "https://www.youtube.com/watch?v=5V2E7-3Y7-Q", # Βίντεο για Γίγαντες
