...
products = {
    "Φακή Χασίων": {
        ...
        "video": "https://www.youtube.com/watch?v=nYxNnkq9_wI" # Νέο βίντεο ψεκασμού
    },
    "Φασόλια Γίγαντες": {
        ...
        "video": "https://www.youtube.com/watch?v=rMYmgGzIEZg" # Νέο βίντεο DJI T100
    }
}
...
try:
    ...
    st.error("Η εικόνα δεν βρέθηκε στο GitHub.")
...
# 4. Βίντεο Ψεκασμού Drone
st.markdown('<div class="section-header">🚁 Drone Spraying In Action</div>', unsafe_allow_html=True)
st.video(p['video'])
...
<div class="info-card" style="border-left: 5px solid #81c784;">
    ...
    <p style="margin:2px;">• <b>Συσκευή:</b> DJI Agras Series</p>
