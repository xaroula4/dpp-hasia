...
products = {
    "Φακή Χασίων": {
        ...
        "img": "fakes.JPEG", "bio_img": "bio.png",
    ...
    "Φασόλια Γίγαντες": {
        ...
        "img": "gigantes.png", "bio_img": "bio.png",
...
# Εικόνες (Συσκευασία + Σήμα Bio με κείμενο)
...
with col2:
    if os.path.exists(p['bio_img']):
        ...
        st.warning("⚠️ bio.png not found")
...
st.markdown("<p style='text-align:center; font-size:11px; color:#999; margin-top:20px;'>Hasia Beans DPP v4.2 | 2026</p>", unsafe_allow_html=True)
