...
# Εικόνες (Συσκευασία + Σήμα Bio μόνο αν είναι True)
...
st.markdown("<p style='text-align:center; font-size:11px; color:#999; margin-top:20px;'>Hasia Beans DPP v4.3 | 2026</p>", unsafe_allow_html=True)
